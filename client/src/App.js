              ...
              <div className="player-count-selector">
                ...
                <div className="count-info">
                  <div className="info-row">
                    ...
                    <span className="value">{targetPlayerCount - getHexeCount(targetPlayerCount)}</span>
                  </div>
                  <div className="info-row">
                    <span className="label">Hexen:</span>
                    <span className="value">{getHexeCount(targetPlayerCount)}</span>
                  </div>
                </div>
              </div>
...
function getHexeCount(playerCount) {
  const guardianMap = {
